...
for i in range(len(datasets)):
    ...
    # img = cv2.imread("/Users/JianingYao/Desktop/Research/Biostatistics_JHU/Stephanie/Code/SpaGCN/data/" + str(dataset) + "/histology-" + str(dataset) + ".tif")
    ...
    plt.savefig('./result/coded_' + dataset + '_ref_spagcn.png', dpi=600)
    plt.close()
