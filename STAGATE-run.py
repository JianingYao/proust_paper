...
for s in sample:
    if s == "histology":
        ...
        for i in range(len(l)):
            ...
            input_dir = '/Users/JianingYao/Desktop/Research/Biostatistics_JHU/Stephanie/Code/DeepST-main/Data/1.DLPFC/' + str(section_id)
            ...
            plt.savefig('./result/' + section_id + '_ref_stagate.png', dpi=600)
            plt.close()
    ...
    if s == "IF":
        ...
        for i in range(len(l)):
            ...
            input_dir = '/Users/jianingyao/Desktop/Research/Biostatistics_JHU/Stephanie/Data/Visium-DLPFC/' + str(section_id)
            adata = sc.read_visium(path=input_dir, count_file='filtered_feature_bc_matrix.h5')
            adata.var_names_make_unique()
            adata
            ...
            ax = sc.pl.embedding(adata,
                                 ...
                                 title=['ARI=%.4f' % ARI])
            ax.set_aspect('equal', 'box')
            plt.savefig('./result/coded_' + section_id + '_ref_stagate.png', dpi=600)
            plt.close()
