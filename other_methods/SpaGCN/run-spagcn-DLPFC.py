...
for i in range(len(datasets)):
    dataset = datasets[i]
    print("################################ " + str(dataset) + " #####################################")
    file_fold = '/Users/jianingyao/Desktop/Research/Biostatistics_JHU/PhD/Data/proust_datasets/spatialDLPFC/' + str(dataset)
    ...
    img = cv2.imread("/Users/jianingyao/Desktop/Research/Biostatistics_JHU/PhD/Data/proust_datasets/spatialDLPFC/" + str(dataset) + "/spatial/full_image.tif")
